      ...
      <section className="py-5">
        <div className="container py-5">
          <div className="text-center max-w-700 mx-auto mb-5">
            ...
            <h2 className="display-5 fw-bold mb-3 text-eco-dark">Soluciones Especializadas</h2>
            <p className="lead text-eco-gray">
          ...
          <div className="row g-4">
            ...
            <div className="col-md-6 col-lg-4">
              <div className="card h-100 border-0 shadow service-card rounded-4 transition-all">
                <div className="card-body p-5">
                  ...
                  <p className="text-eco-gray mb-0">
